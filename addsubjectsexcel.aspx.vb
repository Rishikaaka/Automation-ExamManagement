...
Partial Class addsubjectsexcel
    ...
    Protected Sub Button1_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles Button1.Click
        ...
        Try
            ...
            For i = 0 To ds.Tables(0).Rows.Count - 1
                ...
                Dim qry = "insert into subjects(subjectcode,subjectname,year,sem) values('" & r(0) & "','" & r(1) & "'," & r(2) & ",'" & r(3) & "')"
                Dim com As New SqlCommand(qry, con)
                com.ExecuteNonQuery()
            Next
            con.Close()
            MyConnection.Close()
            Literal1.Text = "<h1> Subjects Added Successfully...</h1>"
