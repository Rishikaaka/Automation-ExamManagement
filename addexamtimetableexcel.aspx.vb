...
Partial Class addexamtimetableexcel
    ...
    Protected Sub Button1_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles Button1.Click
        ...
        Try
            ...
            For i = 0 To ds.Tables(0).Rows.Count - 1
                ...
                Dim qry = "insert into examtimetable(examtype,year,sem,branch,examdate,session,day,subjectname) values('" & r(0) & "'," & r(1) & "," & r(2) & ",'" & r(3) & "','" & r(4) & "','" & r(5) & "','" & r(6) & "','" & r(7) & "')"
                Dim com As New SqlCommand(qry, con)
                com.ExecuteNonQuery()
            Next
            con.Close()
            MyConnection.Close()
            Literal1.Text = "<h1> Exam timetable Added Successfully...</h1>"
